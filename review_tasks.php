...
<head>
<meta charset="UTF-8">
<title>Approve / Rollback Tasks</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<style>
/* background, sidebar, header, main same as before */
body {
    margin:0;
...
<div class="sidebar">
    ...
    <a href="approve_permission.php"><i class="fas fa-user-check"></i> Approve Permission</a>
