...
.task-card h3 { margin: 0; font-size: 16px; color: #1F5F60; text-align: center; }
.task-card p { margin: 0; font-size: 14px; color: #555; text-align: center; }
        ...
        <?php if (!empty($task['file_path'])): ?>
            <p>
                📂 <a href="<?= htmlspecialchars($task['file_path']) ?>" 
                      download 
                      style="color:#1581A1; text-decoration:none; font-weight:bold;">
